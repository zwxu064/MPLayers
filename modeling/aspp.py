...
class ASPP(nn.Module):
    def __init__(self, backbone, output_stride, BatchNorm, enable_aspp=True):
        ...
        conv1_in_c = 1280 if enable_aspp else 2048
...
def build_aspp(backbone, output_stride, BatchNorm, enable_aspp=True):
